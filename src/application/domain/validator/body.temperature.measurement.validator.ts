...
import { BodyTemperatureMeasurement } from '../model/body.temperature.measurement'

export class BodyTemperatureMeasurementValidator {
    public static validate(item: BodyTemperatureMeasurement): void | ValidationException {
