...
export class BloodPressurePerSystolicDiastolic
    implements IJSONSerializable, IJSONDeserializable<BloodPressurePerSystolicDiastolic> {
    ...
    public fromJSON(json: any): BloodPressurePerSystolicDiastolic {
        if (!json) return this
