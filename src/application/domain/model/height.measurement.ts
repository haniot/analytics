...
export class HeightMeasurement extends Measurement implements IJSONSerializable, IJSONDeserializable<HeightMeasurement> {
    ...
    public fromJSON(json: any): HeightMeasurement {
        if (!json) return this
